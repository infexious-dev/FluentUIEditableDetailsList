    ...
    var GetInputFieldContent = function () {
        ...
        if (column.length > 0) {
            ...
            switch (item_1.inputType) {
                ...
                default:
                    return (_jsx(TextField, { errorMessage: columnValuesObj[item_1.key].error, className: localControlClass.inputClass, placeholder: "Enter '".concat(item_1.text, "'..."), onChange: function (ev, text) { return onTextUpdate(ev, text, item_1); }, styles: textFieldStyles, id: item_1.key, value: columnValuesObj[item_1.key].value || '' }, void 0));
            }
        }
